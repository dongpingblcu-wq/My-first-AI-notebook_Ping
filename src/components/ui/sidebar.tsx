...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const [isMobile, _setIsMobile] = React.useState(false)
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[state=open]:ml-64 peer-data-[state=closed]:ml-12",
